...
int Archivo1(Consultas*& lista1, int* tam1, string path);
int Archivo2(Pacientes*& lista1, int* tam1, string path);
int Archivo3(Contactos*& lista1, int* tam1, string path);
